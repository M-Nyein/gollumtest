...
ActiveRecord::Schema.define(version: 20160930103535) do
  ...
  create_table "towns", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["division_id"], name: "index_towns_on_division_id", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["town_id"], name: "index_users_on_town_id", using: :btree
  end

  add_foreign_key "towns", "divisions"
